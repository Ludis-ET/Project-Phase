...
import { emailVerificationSchema, type EmailVerificationFormData } from "@/lib/validationSchemas";
...
export default function VerifyEmailPage() {
  ...
  const { verifyEmail, isLoading } = useNextAuth();
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div className="text-center">
            <p className="text-sm text-gray-600 mb-2">
              ...
              {!canResend && (
                <span className="text-gray-500"> in {formatTime(resendTimer)}</span>
              )}
            </p>
          </div>
